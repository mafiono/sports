        ...
        <div className="profile-view-wrapper">
            ...
            <div className="page-menu-contain">
                <ul>
                    ...
                    ? <li>
                        <Link activeClassName="active" to="/bonus/sport" onlyActiveOnIndex=""><span>{t("Sport Bonus")}</span></Link>
                      </li>
                    : null}
                    {disableCasinoBonus ? <li>
                        <Link activeClassName="active" to="/bonus/casino" onlyActiveOnIndex=""><span>{t("Casino Bonus")}</span></Link>
                    </li> : null}
                </ul>
            </div>
