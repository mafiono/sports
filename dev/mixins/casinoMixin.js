...
var CasinoMixin = ComposedComponent => class CasinoMixin extends React.Component {
    ...
    componentWillReceiveProps (nextProps) {
        ...
        !self.inited && nextProps.casino.categoriesAndProviders && nextProps.casino.categoriesAndProviders.loaded && (function () {
            ...
            openByDefault[0] !== 'favorite' && !self.props.casino.gamesList[`casino_categories_${openByDefault[0]}::${openByDefault[1]}`] && self.props.dispatch(CmsLoadData('getGames'));
        })();
    }
    ...
    loadMore (currentWatchingList) {
        let self = this;
        this.props.dispatch(CmsLoadData('getGames', currentWatchingList.to, currentWatchingList.to + (Config.casino.games.loaderStep || 9)));
    }
    ...
    selectCategory (categoryId, expanded) {
        ...
        return this.props.dispatch(CmsLoadData('getGames')); //eslint-disable-line react/prop-types
    }
